...
Litter.anova.plot1 <- ggplot(subset(Litter, nlcdClass == "evergreenForest"),
                             aes(y = dryMass, x = functionalGroup)) +
  geom_boxplot() +
  ylim(0, 30) +
  theme(axis.text.x = element_text(angle = 55, hjust = 1)) +
  labs(x = "Funtional Group", y = "Dry Mass (g)")
Litter.anova.plot1

Litter.anova.plot2 <- ggplot(subset(Litter, nlcdClass == "grasslandHerbaceous"),
                             aes(y = dryMass, x = functionalGroup)) +
  geom_boxplot() +
  ylim(0, 25) +
  theme(axis.text.x = element_text(angle = 55, hjust = 1)) +
...
Litter.anova.plot3 <- ggplot(subset(Litter, nlcdClass == "shrubScrub"),
                             aes(y = dryMass, x = functionalGroup)) +
  geom_boxplot() +
  # ylim(0, 30) +
  theme(axis.text.x = element_text(angle = 55, hjust = 1)) +
...
library(cowplot)
Litter.anova.plot <- plot_grid(Litter.anova.plot1, Litter.anova.plot2 + 
                                 labs(x = "", y = ""),
                               Litter.anova.plot3, ncol = 3, align = 'h')

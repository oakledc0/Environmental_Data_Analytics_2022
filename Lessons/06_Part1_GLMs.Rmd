...
> I would write out the equation for the line reported by the linear regression and report the p-value and R^2. 
...
corrplot.mixed(PeterPaulCorr, upper = "ellipse") #shows shapes and values
```

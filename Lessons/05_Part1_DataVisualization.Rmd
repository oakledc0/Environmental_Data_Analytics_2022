...
print(O3plot)
#^these two examples do the create the same plot, but the second example allows for displaying the plot at other points in an .rmd
...
NvsP <-
  ...
  geom_point() +
  geom_smooth(method = lm) + #creates trendline; 'lm' stands for linear model 
